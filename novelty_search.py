...
class NovArchive:
    ...
    def update(self,new_bd):
        """ QQ: on obtient une nouvelle KDtree qui inclure new_bd"""
    ...
    def get_nov(self,bd, population=[]):
        dpop=[]
        # QQ: sqrt de la somme des distances de bd to les elements de population
        for ind in population:  
            dpop.append(np.linalg.norm(np.array(bd)-np.array(ind.bd)) )
        # QQ: les distances entre bd et les k plus proches voisins
